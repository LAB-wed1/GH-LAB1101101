...
$(document).ready(function(){
    // ปุ่ม Refresh: รีเซ็ตพื้นหลัง, สีตัวอักษร และแสดง input ทั้งหมด
    ...
    // รูปที่ 4: ดับเบิลคลิก เปลี่ยนสีตัวอักษรเป็นสีแดง
    $("#img4").dblclick(function(){
    $("input, select, button").css("background-color", "blue");
    });
    
    // รูปที่ 5: เมาส์วาง (mouseenter) ซ่อน input ทั้งหมด
